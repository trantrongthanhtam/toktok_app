...
const Navbar = () => {
  ...
  return (
    <div className='w-full flex justify-between items-center border-b-2 border-gray-200 py-2 px-4  sticky top-0 index-100 bg-white z-10' >
      <Link href='/'>
      ...
      <div className='relative hidden md:block'>
        <form onSubmit={handleSearch} className="absolute md:static top-10 left-20 bg-white">
          <input type='text' value={searchValue} onChange={(e)=>setSearchValue(e.target.value)} placeholder='Search accounts and videos' className='bg-primary p-3 md:text-md font-medium border-2 border-gray-100 focus:outline-nont focus:border-2 focus:border-gray-300 w-[300px] mf:w-[350px] rounded-full md:top-0'/>
        ...
        {userProfile ? (
          <div className="flex gap-5 md:gap-10">
            ...
            <button type="button" className='px-2' onClick={()=> {
              ...
              <MdLogout color='darkRed' fontSize={24}/>
            </button>
          </div>
        ) : (
